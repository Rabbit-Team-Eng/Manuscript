//
//  AddCurrentMemberToWorkspaceByWorkspaceIdRequest.swift
//  Manuscript
//
...
struct AddCurrentMemberToWorkspaceByWorkspaceIdRequest {
    ...
    func getRequest(with workspaceId: String) -> URLRequest {
        let urlString = "\(environment.rawValue)\(Endpoint.workspace)/\(workspaceId)/member"
